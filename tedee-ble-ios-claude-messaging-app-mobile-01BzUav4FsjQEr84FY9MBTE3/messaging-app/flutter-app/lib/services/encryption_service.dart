...
class EncryptionService {
  ...
  RSAPrivateKey _decodePrivateKey(String privateKeyStr) {
    try {
      ...
      final modulus = (privateKeySeq.elements![1] as ASN1Integer).value;
      final publicExponent = (privateKeySeq.elements![2] as ASN1Integer).value;
      final privateExponent = (privateKeySeq.elements![3] as ASN1Integer).value;
      final p = (privateKeySeq.elements![4] as ASN1Integer).value;
      final q = (privateKeySeq.elements![5] as ASN1Integer).value;
