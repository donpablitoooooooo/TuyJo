...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  void didChangeDependencies() async {
    ...
    // 🎯 NON ascoltare PairingService qui (listen:false)
    // Il listener manuale in initState() triggera setState() quando serve
    final pairingService = Provider.of<PairingService>(context, listen: false);
    final currentPairingStatus = pairingService.isPaired;
...
/// Contenuto della bubble che può essere aggiornato senza ricreare l'animazione
/// Questo widget viene ricostruito quando cambia il contenuto, ma NON ricrea l'animazione
