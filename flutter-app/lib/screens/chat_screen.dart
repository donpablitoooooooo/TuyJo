              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: TableCalendar(
                      ...
                      calendarStyle: CalendarStyle(
                        ...
                        selectedTextStyle: const TextStyle(color: Color(0xFF2A8C94), fontWeight: FontWeight.bold),
                        ...
                        rangeStartTextStyle: const TextStyle(color: Color(0xFF2A8C94), fontWeight: FontWeight.bold),
                        rangeEndDecoration: BoxDecoration(
                          color: Colors.white.withOpacity(0.9),
                          shape: BoxShape.circle,
                        ),
                        rangeEndTextStyle: const TextStyle(color: Color(0xFF2A8C94), fontWeight: FontWeight.bold),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF1F6B73).withOpacity(0.3),
                  ),
                  child: Row(
                          ...
                          Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<int?>(
                                ...
                                dropdownColor: const Color(0xFF1F6B73),
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: _canSend
                            ? [
                                BoxShadow(
                                  color: const Color(0xFF2A8C94).withOpacity(0.4),
                                  blurRadius: 8,
                                  offset: const Offset(0, 2),
                                ),
                              ]
